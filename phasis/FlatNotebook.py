...
# personalizzazione per dimensione font

#DIM_FONT=wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
DIM_FONT=None
...
class TabNavigatorWindow(wx.Dialog):
    ...
    def __init__(self, parent=None):
        ...
        font = set_dim_font() #wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
...
class FNBRenderer:
    ...
    def CalcTabWidth(self, pageContainer, tabIdx, tabHeight):
        ...
        boldFont = set_dim_font() #wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
    ...
    def CalcTabHeight(self, pageContainer):
        ...
        normalFont = set_dim_font() #wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
        boldFont = normalFont

        if "__WXGTK__" in wx.PlatformInfo: pass
        boldFont.SetWeight(wx.FONTWEIGHT_BOLD)
...
# presonalizzazione per dimensione font ==========

def set_dim_font():
    #DIM_FONT=wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
    #x,y=wx.ScreenDC().GetSizeTuple()
    #x=wx.ScreenDC().MaxX()
    y=wx.ScreenDC().MaxY()
    ...
    DIM_FONT=wx.Font(numfont, wx.SWISS, wx.NORMAL, wx.NORMAL, False)
    return DIM_FONT
...
class FlatNotebook(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize,
        ...
        # personalizzazione
        #DIM_FONT=wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
        #DIM_FONT=wx.Font(20, wx.SWISS, wx.NORMAL, wx.NORMAL, False)
        #set_dim_font()
        ###############################
